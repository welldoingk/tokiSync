...
## Corpus Check
- 148 files · ~159,127 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2969 nodes · 6861 edges · 159 communities (137 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a866bb3`
...
Cohesion: 0.02
Nodes (141): _0, a0, ab, Ah, as(), at, av, ay (+133 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (103): addKeys(), Ae, ag(), Ai(), bg, bl(), bn(), Bo (+95 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (70): a, activeWorkers, addEpisodesToQueue(), apply(), arrayBufferToBase64(), blob, builder, checkInjection() (+62 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (62): af, Ar(), Bc(), Bi(), Cc, ch(), _d(), dd() (+54 more)
...
Cohesion: 0.06
Nodes (48): Ao(), Ap(), bm, cm, Co(), Ct(), El, en() (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (58): _a(), Al, au(), bf, Ce(), cf(), ci, cn() (+50 more)
...
Cohesion: 0.08
Nodes (56): Ad(), An(), bd(), Be(), Bs(), bt(), _c, ca() (+48 more)
...
Cohesion: 0.08
Nodes (23): EpubBuilder, extractEpisodeData(), blob, config, originalConsole, result, url, startWorker() (+15 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (35): ba(), Dn(), du(), $e(), er, Fo(), gi, Ho() (+27 more)
...
Cohesion: 0.13
Nodes (33): fetchImages(), generateDownloadReport(), parseRangeSpec(), processItem(), SLEEP_POLICIES, tokiDownload(), arrayBufferToBase64(), fetchHistory() (+25 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (14): da(), fa(), fc(), getDatabaseNames(), ha(), ne, om, _p() (+6 more)

### Community 24 - "Community 24"
Cohesion: 0.12
Nodes (27): checkSingleHistoryDirect(), cleanNovelParagraphs(), EpubBuilder, fetchHistory(), fetchHistoryDirect(), fetchImages(), fetchMediaViaWorkerSingleAttempt(), fetchToken() (+19 more)

### Community 25 - "Community 25"
Cohesion: 0.1
Nodes (22): closeActivePopup(), closeActiveWorker(), fetchComicImages(), fetchMediaViaPopup(), fetchMediaViaPopupSingleAttempt(), fetchMediaViaWorker(), generateDownloadReport(), get() (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (23): aa(), ac(), add(), addKey(), bh(), dh(), dp, Go() (+15 more)
...
Cohesion: 0.08
Nodes (26): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (LOCAL_PATH=$(graphify clone <github-url> [--branch <branch>]), code:bash (graphify export wiki), code:bash (graphify export neo4j), code:bash (graphify export neo4j --push bolt://localhost:7687 --user ne), code:bash (graphify export svg), code:bash (graphify export graphml) (+18 more)

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (6): CbzBuilder, getConfig(), isConfigValid(), LogBox, MenuModal, showConfigModal()

### Community 34 - "Community 34"
Cohesion: 0.1
Nodes (6): hh, Lt(), Qi(), x0(), y0, Zn
...
Cohesion: 0.09
Nodes (22): Changelog, 🐛 GAS 번들 빌더 누락 핫픽스 (DriveAccessService 해결), [v1.10.0] - 2026-05-18, [v1.1.3] - 2026-01-XX, [v1.20.6] - 2026-05-28, [v1.3.5] - 2026-02-06, [v1.7.2] - 2026-04-03, [v1.7.3] - 2026-04-08 (+14 more)
...
Cohesion: 0.16
Nodes (12): getConfig(), isConfigValid(), setConfig(), showConfigModal(), detectSite(), main(), ParserFactory, customDeployId (+4 more)
...
Cohesion: 0.16
Nodes (16): cr, dm, Ee(), eh(), iu(), Ja(), lm, Me() (+8 more)
...
Cohesion: 0.22
Nodes (8): EventBus, EVT, _listeners, mockLogBox, mockLogs, mockUI, mockWindow, unsubscribe
...
## Knowledge Gaps
- **868 isolated node(s):** `loaderMajor`, `requiredMajor`, `pkg`, `IGNORE_TAGS`, `KEEP_ATTRS` (+863 more)
...
- **Why does `r()` connect `Community 26` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 38`, `Community 10`, `Community 47`, `Community 48`, `Community 19`, `Community 54`, `Community 23`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `a` connect `Community 6` to `Community 3`, `Community 5`, `Community 13`, `Community 47`, `Community 48`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `tokiDownload()` connect `Community 4` to `Community 38`?**
...
- **Are the 18 inferred relationships involving `H()` (e.g. with `rm` and `.open()`) actually correct?**
