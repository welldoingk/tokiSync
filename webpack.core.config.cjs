...
// @version      1.20.5-custom.260531-12
// @description  Toki series sites -> Google Drive syncing tool (Bundled) — LAN custom build (작품 메인 URL 자동 펼침: 유저스크립트 버튼 + 대시보드 → 클라이언트가 전체 회차 추출해 lease 풀 투입)
