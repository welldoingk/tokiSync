...
// @version      1.20.5-custom.260601-3
// @description  Toki series sites -> Google Drive syncing tool (Bundled) — LAN custom build (회차 폴더명을 메인 페이지에서 계산해 동봉: [id] 작품명 일관·외전 동일폴더)
