...
// @version      1.20.5-custom.260531-7
// @description  Toki series sites -> Google Drive syncing tool (Bundled) — LAN custom build (소설 본문 추출 자동화: /novel/ URL이면 force-open 자동 ON, 만화는 자동 OFF — 토글 불필요)
