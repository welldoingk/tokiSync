...
// @version      1.20.5-custom.260531-2
// @description  Toki series sites -> Google Drive syncing tool (Bundled) — LAN custom build (FIX: attachShadow Proxy를 워커 전용으로 스코프 → sbxh 안티-변조 탐지 회피, 만화 로드 정상화)
