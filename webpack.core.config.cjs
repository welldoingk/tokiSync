...
// @version      1.20.5-custom.260531-6
// @description  Toki series sites -> Google Drive syncing tool (Bundled) — LAN custom build (소설 본문 추출: 닫힌 shadow 강제열기 토글 + 워커 호스트 셀렉터 sbxh 대응)
