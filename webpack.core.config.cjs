...
// @version      1.20.5-custom.260601-13
// @description  Toki series sites -> Google Drive syncing tool (Bundled) — LAN custom build (소설 줄거리(summary) 폴백 셀렉터 .nd-desc — remote 룰 미정의 보완)
